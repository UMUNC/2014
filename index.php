    ...
    <div id="layerslider-container-fw">        
        <div id="layerslider" style="width: 100%; height: 550px; margin: 0px auto; ">
            ...
            <div class="ls-layer" style="sliderdirection: top;">
                ...
                <a class="btn-u btn-u-blue ls-s-1" href="2014_nat.php" style=" padding: 9px 20px; font-size:25px; top:320px; left: 50px; slidedirection : bottom; slideoutdirection : bottom; durationin : 2000; durationout : 2000; ">
                    了解会议
                </a>
            ...
            <div class="ls-layer" style="sliderdirection: top;">
                ...
                <a class="btn-u btn-u-blue ls-s-1" href="tech.php" style=" padding: 9px 20px; font-size:25px; top:310px; left: 750px; slidedirection : bottom; slideoutdirection : bottom; durationin : 2000; durationout : 2000; ">
                    了解更多
                </a>
            </div>
            ...
            <div class="ls-layer" style="sliderdirection: right; transition2d: 92,93,105;">
                ...
                <a class="btn-u btn-u-blue ls-s-1" href="history.php" style=" padding: 9px 20px; font-size:25px; top:370px; left: 20px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 3000; ">
                    了解更多
                </a>
