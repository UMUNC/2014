...
<head>
    <title>UMUNC | 2014 National Conference</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 coming-soon">
            <h1 style="margin-top: 40px;">UMUNC 2014 National Conference Countdown<br><br>"U梦"模拟联合国组织2014年全国总会倒计时</h1>
            <p style="font-size: 29px; margin-top: 40px; line-height: 36px;">
                We see you at July 22nd in Beijing!<br>7月22号，我们北京见！
            </p>
        </div>
    </div>
    ...
    <div class="coming-soon-plugin">
        ...
        <div class="col-md-12 coming-soon">
            <a class="btn btn-primary btn-lg" style="font-size: 30px; text-align: center;" href="register.html">APPLY NOW 报名会议</a>
        </div>
    </div>
</div><!--/container-->

<div class="breadcrumbs" style="background: #fff; margin-top: 40px; padding-left: 135px; padding-right: 135px; padding-top: 60px;">
    <!-- SEC -->
    <div class="headline">
    ...
    <!-- Academic System -->
    <div class="headline">
        <h2>Introduction of Academic Systems of UMUNC National Conference 2014<br>2014年UMUNC全国总会学术体系介绍</h2>
    </div>
    <div class="row margin-bottom-40">
        <div class="col-md-4">
            <div class="tag-box tag-box-v1 margin-bottom-20">
                <h2>内阁联动体系</h2>
                <p>
                    在内阁联动体系中，代表可能会去扮演几个国家内阁其中的一名内阁成员，代表将拥有这个角色在现实世界的所有权力。
                    代表也可能成为一家著名报社的记者或者主编，这是内阁联动体系中的另一个重要会场，用文字去监督并报道各国内阁的行为，向民众传达他们最想知道的信息。
                    而联合国安全理事会作为具有最高行动力与权限的世界组织，安理会的代表将代表各个国家，参与到危机联动中。
                    安理会的代表将会与场上各个国家进行博弈，代表国家，代表内阁来决议各个草案。<br><br>
                    在内阁联动体系中，我们没有传统委员会的概念，也没有议题。作为联动体系代表，你将面临的是危机中心CORE发出的一个又一个包涵各个领域的危机。
                    运用你手中的权力去解决危机，并且在解决危机的过程中与其他国家内阁斡旋，合作，为本国争取利益，这是对各位代表的斡旋能力，逻辑思维能力，团队合作能力和领导力的一次极大的挑战。
                </p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="tag-box tag-box-v1 margin-bottom-20">
                <h2>欧洲体系</h2>
                <p>
                    欧盟现有机构包括作为最高决策机构的高峰会，也包括立法、行政、司法等机构。
                    为了探寻欧洲联盟体系中机构的运作方式，体验权力分立与机构间合作对于问题解决的影响，UMUNC欧洲体系将运用机构间联动和代表们模拟欧洲联盟的讨论进程。
                    在这里不仅能有欧洲体系自建的欧盟规则，还有集团化的问题解决方式。并且在讨论中，代表在有主持/无主持核心磋商之外，还能运用更自由的圆桌会议模式进行讨论。
                    在面对面的辩论中，代表们能够更加公开直接地抓住问题关键而不必总是寻求外交辞令。
                    各会场间因为权利分立的原因互相制衡，代表们各自有综合的政治背景，这也为联动增添了部分复杂性。
                </p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="tag-box tag-box-v1 margin-bottom-20">
                <h2>"GAUS"体系(General Assembly United System)</h2>
                <p>
                    "GAUS"一改传统，致力于把联大常委同安全理事会联系起来。
                    更加注重对现实世界的仿真，将联大常委与安全理事会放到同一个大背景下运作，权限与信息获取各不相同，利用安理会对决策案的表决权和其赋予的法律效益，
                    让各个委员会能够在同一问题各个方面的处理至臻完美，从而使问题上升到一个新的高度。
                    而各个委员会的决策案在安理会的表决结果将连锁反应到各个执行部门，事件的走势也会随之改变。
                    在"GAUS"，联大委员会将以最具挑战性、最真实的方式呈现给每一位代表。
                </p>
            </div>
        </div>
        <div class="col-md-8">
            <div class="tag-box tag-box-v2">
                <h1>我们会持续更新。委员会信息将于近期放出！</h1>
            </div>
        </div>
    </div>
    ...
    <!-- Download -->
    <div class="headline">
        <h2>Download<br>文件下载</h2>
    </div>
    <div class="row margin-bottom-40">
        <div class="col-md-6">
            <blockquote>
                <h1>
                    <a href="docs/UMUNC_Invitation_2014.pdf">Invitation Letter from Secretary-General<br>秘书长邀请函</a>
                </h1>
            </blockquote>
        </div>
        <div class="col-md-6">
            <blockquote>
                <h1>
                    <a href="docs/UMUNC_2014_Personal.pdf">Personal Registration Form<br>UMUNC2014年全国总会-个人报名表</a>
                </h1>
            </blockquote>
        </div>
        <div class="col-md-6">
            <blockquote>
                <h1>
                    <a href="docs/UMUNC_2014_Team.xls">Group Registration Form<br>UMUNC2014年全国总会-团体报名表</a>
                </h1>
            </blockquote>
        </div>
    </div>
...
<script type="text/javascript">
    $(function () {
        var austDay = new Date("2014-07-22");
